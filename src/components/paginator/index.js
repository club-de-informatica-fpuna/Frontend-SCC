    ...
    render(){
        ...
        return(
            <section style={{textAlign: "right"}}>
                <Button className="btn-paginator-default" onClick={this.props.first.bind(this)}><FaAngleDoubleLeft/></Button>&nbsp;&nbsp;
                ...
                <Button className="btn-paginator-default" onClick={this.props.last.bind(this)}><FaAngleDoubleRight/></Button>
            </section>
        );
